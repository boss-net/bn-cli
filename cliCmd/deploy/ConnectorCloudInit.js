...
export class ConnectorCloudInit {
    constructor(options={}) {
        ...
        this.runCommands = [
            ...
            [ "systemctl", "enable", "Boss-net-connector.service" ],
            [ "systemctl", "start", "--no-block", "Boss-net-connector.service" ]
        ];
    ...
    setStaticConfiguration(accountUrl, tokens, extraEnv={}) {
        const conf = {};
        conf["BOSSNET_URL"] = accountUrl;
        conf["BOSSNET_ACCESS_TOKEN"] = tokens.accessToken;
        conf["BOSSNET_REFRESH_TOKEN"] = tokens.refreshToken;
        for ( const [key, value] of Object.entries(extraEnv) ) {
            conf[`BOSSNET_${key}`] = value;
        }
