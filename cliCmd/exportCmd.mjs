...
async function outputDot(client, options) {
    ...
    const configForGraph = {
        ...
        fieldSet: [BossnetApiClient.FieldSet.ID, BossnetApiClient.FieldSet.LABEL,
            BossnetApiClient.FieldSet.NODES, BossnetApiClient.FieldSet.CONNECTIONS],
        recordTransformOpts: {
            mapNodeToId: true
        }
    }
...
async function exportJson(client, options) {
    const configForExport = {
        ...
        fieldOpts: {
            defaultObjectFieldSet: [BossnetApiClient.FieldSet.ID]
        },
...
async function exportExcel(client, options) {
    const configForExport = {
        defaultConnectionFields: "LABEL_FIELD",
        fieldOpts: {
            defaultObjectFieldSet: [BossnetApiClient.FieldSet.LABEL]
        },
        joinConnectionFields: (connections) => {
